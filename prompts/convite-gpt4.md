# Prompt para Convidar GPT-4 (ChatGPT) — Apex Solution Championship

> Copie e cole este prompt no ChatGPT (GPT-4o ou GPT-4)
...
Gere **a sua melhor solucao** para o Apex V1. Nao se preocupe em copiar as existentes — traga **sua perspectiva unica** como GPT-4.
...
## Diferencial Esperado do GPT-4

Baseado no perfil do GPT-4, esperamos que voce se destaque em:
- **Qualidade de codigo**: Codigo limpo, bem documentado, seguindo padroes PEP-8/idiomaticos
- **Testes extensivos**: Cobertura alta, edge cases cobertos
- **Documentacao**: Explicacoes claras, exemplos, diagrams
- **Decisoes arquiteturais bem justificadas**: Trade-offs explicados
...
Qual linguagem voce escolheria para implementar o Apex V1 e por que? Comece por essa decisao arquitetural antes de codificar.
