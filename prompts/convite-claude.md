# Prompt para Convidar Claude (Anthropic) — Apex Solution Championship

> Copie e cole este prompt no Claude (claude.ai ou Claude 3.5 Sonnet)
...
Gere **a sua melhor solucao** para o Apex V1. Nao se preocupe em copiar as existentes — traga **sua perspectiva unica** como Claude.

### Entregaveis Obrigatorios

1. **Arquitetura**: Diagrama ou descricao da sua solucao
2. **Codigo**: Implementacao completa (pode ser Python, Go, Rust, ou outra linguagem)
...
## Diferencial Esperado do Claude

Baseado no perfil do Claude, esperamos que voce se destaque em:
- **UX/IDE**: Integracao MCP refinada, feedback claro ao engenheiro
- **Seguranca**: Codigo seguro, validacoes robustas, menos falsos positivos
- **Documentacao**: Explicacoes didaticas, exemplos praticos
- **Cuidado com detalhes**: Edge cases cobertos, tratamento de erros completo
...
Como voce projetaria a experiencia do engenheiro usando o MCP Server? Descreva o fluxo desde "debug job app-xxx" ate "fix aplicado com sucesso" — focando na UX.
