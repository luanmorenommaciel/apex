...
A rodada nova mudou o placar tecnico da engine Codex: alem de G0-G5, ela agora tem stack autonoma com G3/G5 completos sem `plat-v0`, SparkListener JVM real com fail-safe e smoke MCP por subprocesso no estilo cliente IDE. Isso nao transforma a branch em V1 final, porque ainda faltam IDE GUI real e Crew.ai/Judge real, mas remove dois gaps grandes que antes pesavam contra L2/L3.
...
|---|---|---:|---|
| Codex Round2 | `campeonato/codex-round2` | `ba28cf4` | HEAD local e remoto sincronizados no fechamento anterior |
...
| Codex antiga | `origin/gustocezar/feature/desacoplamento-geradores` | `bd8a08b` | Slice antigo de desacoplamento, nao e a Round2 atual |
...
| Dimensao | Cowork | Kimi | Codex antiga | Codex Round2 | Agmar/Spike | DataFlint |
|---|---|---|---|---|---|---|
| Plataforma Spark/MinIO/ClickHouse | P | P | N | V local autonoma | V | E |
| Event log real | V/P | P | V skew | V G3 + G3 autonomo | V | E |
| ClickHouse source of truth | P | V/P mock | N | V adapter/schema | V | E |
| Detectores oficiais | P | P | P skew | V 5 oficiais | V 5+ | E alertas/produto |
| Baseline negativo | P | P | N | V | P/V | E |
| EvidenceValidator | P | V/P | P | V | N/P | E proprietario |
| T1 sem LLM | P | P | V slice | V 226.991 ms | P | N/A |
| LLM/agentico | V/P Crew | P | N | P, futuro | P opcional | E |
| MCP | V/P | P HTTP/stdio | N | V stdio + subprocess | P stdio | E Spark MCP |
| apply_fix/apply guardado | V/P | N | N | V `apply_fix` + token/hash | N/P | E fixes no IDE |
| Rerun/compare | P | N/P | P oracle | V G5 real + autonomo | P/V | E |
| SparkListener JVM | P skeleton | P | N | V runtime/fail-safe | P/eventlog native | E plugin |
...
| Criterio | Cowork | Kimi | Codex antiga | Codex Round2 | Agmar/Spike | DataFlint |
|---|---:|---:|---:|---:|---:|---:|
| C1 Arquitetura V1 | 3 | 3 | 1 | 4 | 4 | 4 |
| C2 Cobertura de deteccao | 2 | 3 | 1 | 5 | 5 | 5 |
| C3 Confiabilidade | 3 | 3 | 3 | 4 | 4 | 4 |
| C4 Loop IDE/apply | 5 | 1 | 0 | 4 | 2 | 5 |
| C5 Qualidade de engenharia | 4 | 4 | 3 | 4 | 4 | 4 |
| C6 Custo/latencia | 2 | 4 | 4 | 5 | 3 | 3 |
| Total | 19/30 | 18/30 | 12/30 | 26/30 | 22/30 | 25/30 |

Leitura honesta:

- Codex Round2 lidera como evidencia executavel local, agora com stack autonoma, listener e loop real/autonomo.
...
flowchart LR
    ...
    CX["Codex Round2<br/>G0-G5 + autonomo + listener + MCP smoke"] --> V1
...
Fontes oficiais consultadas em 2026-07-14:
...
| Review Agent | comentario em PR com regressao | gates G0-G5 como criterio objetivo |
...
| Risco | Estado em 14/07 | Acao recomendada |
|---|---|---|
| IDE GUI real nao validada | Codex tem subprocess smoke, nao Cursor/VS Code real | rodar smoke com IDE real |
