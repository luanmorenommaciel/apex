  ...
  def emit(ev: ApexStageEvent): Unit = Try {
    ...
    try {
      span
        ...
        .setAttribute(ApexAttributes.ExecutorRunTimeMs, Long.box(ev.executor_run_time_ms))
        ...
        .setAttribute(ApexAttributes.TaskDurationSampleCount, Long.box(ev.task_duration_sample_count.toLong))
        .setAttribute(ApexAttributes.SuccessfulTaskDurationP50Ms, Long.box(ev.successful_task_duration_p50_ms))
        .setAttribute(ApexAttributes.SuccessfulTaskDurationP99Ms, Long.box(ev.successful_task_duration_p99_ms))
        .setAttribute(ApexAttributes.SuccessfulTaskDurationMaxMs, Long.box(ev.successful_task_duration_max_ms))
        .setAttribute(ApexAttributes.SuccessfulTaskSampleCount, Long.box(ev.successful_task_sample_count.toLong))
        .setAttribute(ApexAttributes.SuccessfulTaskShuffleReadBytesP50, Long.box(ev.successful_task_shuffle_read_bytes_p50))
        .setAttribute(ApexAttributes.SuccessfulTaskShuffleReadBytesMax, Long.box(ev.successful_task_shuffle_read_bytes_max))
        .setAttribute(ApexAttributes.SuccessfulTaskShuffleReadBytesSampleCount, Long.box(ev.successful_task_shuffle_read_bytes_sample_count.toLong))
        .setAttribute(ApexAttributes.TaskAttemptCount, Long.box(ev.task_attempt_count.toLong))
        .setAttribute(ApexAttributes.TaskFailedAttemptCount, Long.box(ev.task_failed_attempt_count.toLong))
        .setAttribute(ApexAttributes.TaskCountedFailureAttemptCount, Long.box(ev.task_counted_failure_attempt_count.toLong))
        .setAttribute(ApexAttributes.TaskKilledAttemptCount, Long.box(ev.task_killed_attempt_count.toLong))
