-- Lane 7 (memory) — PROPOSED contract v0.3 additive · apex.plan_memory
--
-- STATUS: PROPOSED, not ratified. Lives here so the memory lane is unblocked.
-- On ratification this file moves to contract/plan_memory.ddl.sql and infra/sql/.
-- Rule (unchanged): a lane may ADD a column; never rename or repurpose one.
--
