...
Every tool but recall_similar_runs reasons about ONE run. `recall_similar_runs`
is the first that reasons across them, over the contract v0.3 memory tables.
"""
