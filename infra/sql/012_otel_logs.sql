-- Apex infra · exporter-owned OTLP logs schema for collect interoperability.
-- The collector declares a logs pipeline alongside traces; pre-create its
-- ClickHouse target in the canonical infra database.
