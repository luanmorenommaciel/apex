...
| Crew.ai external smoke | Chegou ao provedor, bloqueado por quota/billing | `tools/crew_judge_provider_smoke.py`; `evidence/crew-judge-external-llm-success-2026-07-19.json`; `ISSUES.md` CODEX-065/CODEX-068 |
...
| Crew.ai/Judge | Provider plugável existe como `crew_judge_diagnose`; `crewai` está instalado, `APEX_CREW_JUDGE_ENABLED=1` foi testado, chamada externa chegou à OpenAI, mas parou em `429 insufficient_quota` |
