...
| CODEX-015 | F3/G3 | blocker | ambiente Docker não subiu para validar G3: Docker Desktop/Linux engine indisponível em `npipe:////./pipe/dockerDesktopLinuxEngine`; não foi possível validar MinIO/S3A, worker 8 cores, job real ou gate multicore | `evidence/g3-environment.log` | aberta |
